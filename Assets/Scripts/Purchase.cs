...
public class Purchase : MonoBehaviour, IStoreListener
{
    ...
    public static string Product_14_99 = "consumable";
    public static string Product_49_99 = "consumable";
    public static string Product_79_99 = "consumable";
    public static string Product_144_99 = "consumable";
    ...
    public void Buy79_99()
    {
        // Buy the consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(Product_79_99);
    }
    public void Buy144_99()
    {
        // Buy the consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(Product_144_99);
    }
    public void Buy299_99()
    {
        // Buy the consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(Product_299_99);
    }
    #endregion
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        {
            Debug.Log("You have purchase 100 Dumplings. Thank you.");
        }
        else if (String.Equals(args.purchasedProduct.definition.id, Product_14_99, StringComparison.Ordinal))
        {
            Debug.Log("You have purchase 1,000 Dumplings. Thank you.");
        }
        // Or ... a subscription product has been purchased by this user.
        else if (String.Equals(args.purchasedProduct.definition.id, Product_49_99, StringComparison.Ordinal))
        {
            Debug.Log("You have purchase 5,000 Dumplings. Thank you.");
        }
        else if (String.Equals(args.purchasedProduct.definition.id, Product_79_99, StringComparison.Ordinal))
        {
            Debug.Log("You have purchase 12,000 Dumplings. Thank you.");
        }
        else if (String.Equals(args.purchasedProduct.definition.id, Product_144_99, StringComparison.Ordinal))
        {
            Debug.Log("You have purchase 25,000 Dumplings. Thank you.");
        }
        else if (String.Equals(args.purchasedProduct.definition.id, Product_299_99, StringComparison.Ordinal))
        {
            Debug.Log("You have purchase 100,000 Dumplings. Thank you.");
        }
        else
        {
